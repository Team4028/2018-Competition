...
2) Claim the button/joystick by writing the proposed functionality in Table 1.1
	EXAMPLE:     DRIVER_BACK_BUTTON		Cosmic Ray Gun Fire
3) Change the name of the method used to access the properties of said button/joystick
...
public class OI {
		...
		// constructors follow
		//============================================================================================
		public OI(int driverGamePadUsbPort, int operatorGamePadUsbPort, int engineeringGamePadUsbPort) {
			_driverGamepad = new XboxController(driverGamePadUsbPort);				// std Logitech F310 Gamepad  
			_operatorGamepad = new XboxController(operatorGamePadUsbPort);			// std Logitech F310 Gamepad  
			_engineeringGamepad = new XboxController(engineeringGamePadUsbPort);		// std Logitech F310 Gamepad  
