...
public class CubeHandler implements Subsystem {
	...
	public void elevator_ScaleHeight_BumpPositionUp() {
		if(_requestedPresetPosition == ELEVATOR_PRESET_POSITION.NEUTRAL_SCALE_HEIGHT
			...
			System.out.println("Bump Up Only honored when requested position is Scale,Climb or Switch ");
		}
	}
	...
	public void elevator_ScaleHeight_BumpPositionDown() {
		if(_requestedPresetPosition == ELEVATOR_PRESET_POSITION.NEUTRAL_SCALE_HEIGHT
			...
			System.out.println("Bump Down Only honored when requested position is Scale,Climb or Switch  ");
		}
	}
	...
	public void acquireCube_InfeedAndCarriage_auton()
	{
