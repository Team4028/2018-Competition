...
public class InFrontOfPyramidtoRightSwitch implements PathContainer {
    ...
    public Path buildPath() {
        ...
        sWaypoints.add(new Waypoint(65,162,18,Constants.NormalSpeed));
        sWaypoints.add(new Waypoint(95,224,20,Constants.NormalSpeed));
        sWaypoints.add(new Waypoint(122,224,0,Constants.NormalSpeed));
